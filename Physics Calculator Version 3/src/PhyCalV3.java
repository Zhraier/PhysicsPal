...
public class PhyCalV3 extends JFrame implements ActionListener{
	...
	JLabel solut = new JLabel();
	JLabel solutop = new JLabel();
	JLabel solutop2 = new JLabel();
	JLabel solut1 = new JLabel();
	JLabel solutop1 = new JLabel();
	JLabel solutop3 = new JLabel();
	JLabel solcor = new JLabel();
	JLabel solcor2 = new JLabel();
	...
	private void removeComponentsGresa() {
	    Component[] components = gresa.getContentPane().getComponents(); // Get all components in the content pane
	    for (Component component : components) {
	        if(component != comboBox) { // Don't remove the combo box
	            gresa.getContentPane().remove(component); // Remove the component
	        }
	    }
	    gresa.revalidate(); // Revalidate the frame to update the layout
	    gresa.repaint(); // Repaint the frame to update the display
	}
	...
	if(comboBox.getSelectedIndex()==0) {
		...
		try {
	        ...
	        if (button2.isSelected()) {
				...
				givenum.setText("P = "+powin+"           T = "+timein);
				givenum.setFont(new Font("Arial",Font.BOLD,25));
				...
				requinum = new JLabel("Work (W = ?)");
				requinum.setFont(new Font("Arial",Font.BOLD,25));
				requinum.setBounds(145, 130, 350, 100);
				...
				solutop2.setText(String.format(powin+"   x   "+timein));
				solutop2.setBounds(110, 270, 400, 75);
				solutop2.setFont(new Font("Arial", Font.BOLD, 30));
				solcor = new JLabel(" = ");
				solcor.setBounds(200, 365, 250, 25);
				solcor.setFont(new Font("Arial",Font.BOLD,30));
				answer2.setText(roundedValue + " Joules");
				answer2.setBounds(100, 437, 250, 30);
				answer2.setFont(new Font("Arial",Font.BOLD,30));
				...
				given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				given.setHorizontalAlignment(SwingConstants.CENTER);
				givenum.setText("W = "+workin+"           T = "+timein);
				givenum.setFont(new Font("Arial",Font.BOLD,25));
				givenum.setBounds(90, 20, 300, 100);
				required.setForeground(Color.decode("#0000ff"));
				required.setFont(new Font("Arial",Font.BOLD,25));
				...
				solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				solution.setHorizontalAlignment(SwingConstants.CENTER);
				solut.setText(String.format(workin+" "));
				solut.setBounds(185, 270, 250, 25);
				solut.setFont(new Font("Arial",Font.BOLD,25));
				solutop = new JLabel("_____________");
				solutop.setBounds(163, 280, 250, 25);
				solutop.setFont(new Font("Arial",Font.BOLD,18));
				solutop2.setText(String.format(timein+" "));
				solutop2.setBounds(210, 285, 250, 75);
				solutop2.setFont(new Font("Arial", Font.BOLD, 25));
				solcor = new JLabel(" = ");
				solcor.setBounds(213, 357, 250, 25);
				solcor.setFont(new Font("Arial",Font.BOLD,25));
				answer2.setText(roundedValue + " Watts");
				answer2.setBounds(113, 407, 250, 30);
				answer2.setFont(new Font("Arial",Font.BOLD,30));
				answer2.setForeground(Color.decode("#009933"));
				answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				answer2.setHorizontalAlignment(SwingConstants.CENTER);
				...
				given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				given.setHorizontalAlignment(SwingConstants.CENTER);
				givenum.setText("W = "+workin+"        P = "+powin);
				givenum.setFont(new Font("Arial",Font.BOLD,25));
				givenum.setBounds(90, 20, 350, 100);
				required.setForeground(Color.decode("#0000ff"));
				required.setFont(new Font("Arial",Font.BOLD,25));
				required.setBounds(0,105,120,40);
				required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				required.setHorizontalAlignment(SwingConstants.CENTER);
				requinum = new JLabel("Time (T = ?)");
				requinum.setFont(new Font("Arial",Font.BOLD,25));
				requinum.setBounds(145, 130, 350, 100);
				solution.setForeground(Color.decode("#0000ff"));
				solution.setFont(new Font("Arial",Font.BOLD,25));
				...
				solutop.setBounds(163, 280, 250, 25);
				solutop.setFont(new Font("Arial",Font.BOLD,18));
				solutop2.setText(String.format(powin+" "));
				solutop2.setBounds(190, 285, 250, 75);
				solutop2.setFont(new Font("Arial", Font.BOLD, 25));
				solcor = new JLabel(" = ");
				solcor.setBounds(213, 357, 250, 25);
				solcor.setFont(new Font("Arial",Font.BOLD,25));
				answer2.setText(roundedValue + " seconds");
				answer2.setBounds(113, 407, 250, 30);
				answer2.setFont(new Font("Arial",Font.BOLD,30));
				answer2.setForeground(Color.decode("#009933"));
				answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
	...
	//calculates all the velocity stuff
			...
			try {
		        ...
		        if (button2.isSelected()) {
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("V = "+velin+"           T = "+vtimein);
					givenum.setFont(new Font("Arial",Font.BOLD,25));
					givenum.setBounds(90, 20, 300, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					required.setHorizontalAlignment(SwingConstants.CENTER);
					requinum = new JLabel("Displacement (D = ?)");
					requinum.setFont(new Font("Arial",Font.BOLD,25));
					requinum.setBounds(115, 130, 350, 100);
					solution.setForeground(Color.decode("#0000ff"));
					solution.setFont(new Font("Arial",Font.BOLD,25));
					solution.setBounds(0,220,120,40);
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					solution.setHorizontalAlignment(SwingConstants.CENTER);
					solutop2.setText(String.format(velin+"   x   "+vtimein));
					solutop2.setBounds(120, 270, 400, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 30));
					solcor = new JLabel(" = ");
					solcor.setBounds(200, 365, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setText(roundedValue + " meters");
					answer2.setBounds(100, 437, 250, 30);
					answer2.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("D = "+dispin+"           T = "+vtimein);
					givenum.setFont(new Font("Arial",Font.BOLD,25));
					givenum.setBounds(90, 20, 300, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					required.setHorizontalAlignment(SwingConstants.CENTER);
					requinum = new JLabel("Velocity (V = ?)");
					requinum.setFont(new Font("Arial",Font.BOLD,25));
					requinum.setBounds(115, 130, 350, 100);
					solution.setForeground(Color.decode("#0000ff"));
					solution.setFont(new Font("Arial",Font.BOLD,25));
					...
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					solution.setHorizontalAlignment(SwingConstants.CENTER);
					solut.setText(String.format(dispin+" "));
					solut.setBounds(205, 270, 250, 25);
					solut.setFont(new Font("Arial",Font.BOLD,25));
					solutop = new JLabel("_____________");
					solutop.setBounds(163, 280, 250, 25);
					solutop.setFont(new Font("Arial",Font.BOLD,18));
					solutop2.setText(String.format(vtimein+" "));
					solutop2.setBounds(210, 285, 250, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 25));
					solcor = new JLabel(" = ");
					solcor.setBounds(213, 357, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,25));
					answer2.setText(roundedValue + " m/s");
					answer2.setBounds(113, 407, 250, 30);
					answer2.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("D = "+dispin+"           V = "+velin);
					givenum.setFont(new Font("Arial",Font.BOLD,25));
					givenum.setBounds(90, 20, 300, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					solutop.setBounds(163, 280, 250, 25);
					solutop.setFont(new Font("Arial",Font.BOLD,18));
					solutop2.setText(String.format(velin+" "));
					solutop2.setBounds(210, 285, 250, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 25));
					solcor = new JLabel(" = ");
					solcor.setBounds(213, 357, 250, 25);
	...
	//calculates all the momentum stuff
			...
			try {
		        ...
		        if (button1.isSelected()) {
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("M = "+massin+"           V = "+mvelin);
					givenum.setFont(new Font("Arial",Font.BOLD,25));
					givenum.setBounds(90, 20, 300, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					required.setHorizontalAlignment(SwingConstants.CENTER);
					requinum = new JLabel("Momentum (P = ?)");
					requinum.setFont(new Font("Arial",Font.BOLD,25));
					requinum.setBounds(115, 130, 350, 100);
					solution.setForeground(Color.decode("#0000ff"));
					solution.setFont(new Font("Arial",Font.BOLD,25));
					...
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					solution.setHorizontalAlignment(SwingConstants.CENTER);
					solutop2.setText(String.format(massin+"   x   "+mvelin));
					solutop2.setBounds(120, 270, 400, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 30));
					solcor = new JLabel(" = ");
					solcor.setBounds(200, 365, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setText(roundedValue + " kg m/s");
					answer2.setBounds(100, 437, 250, 30);
					answer2.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("P = "+momin+"           M = "+massin);
					givenum.setFont(new Font("Arial",Font.BOLD,25));
					givenum.setBounds(90, 20, 300, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					solution.setHorizontalAlignment(SwingConstants.CENTER);
					solut.setText(String.format(momin+" "));
					solut.setBounds(185, 270, 250, 25);
					solut.setFont(new Font("Arial",Font.BOLD,25));
					solutop = new JLabel("_____________");
					solutop.setBounds(163, 280, 250, 25);
					solutop.setFont(new Font("Arial",Font.BOLD,18));
					solutop2.setText(String.format(massin+" "));
					solutop2.setBounds(200, 285, 250, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 25));
					solcor = new JLabel(" = ");
					solcor.setBounds(213, 357, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,25));
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("P = "+momin+"           V = "+mvelin);
					givenum.setFont(new Font("Arial",Font.BOLD,25));
					givenum.setBounds(90, 20, 300, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					solutop.setBounds(163, 280, 250, 25);
					solutop.setFont(new Font("Arial",Font.BOLD,18));
					solutop2.setText(String.format(mvelin+" "));
					solutop2.setBounds(200, 285, 250, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 25));
					solcor = new JLabel(" = ");
					solcor.setBounds(213, 357, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,25));
					answer2.setText(roundedValue + " kg");
					answer2.setBounds(113, 407, 250, 30);
					answer2.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
			...
			if (button1.isSelected()) {
				...
				givenum.setFont(new Font("Arial",Font.BOLD,25));
				givenum.setBounds(60, 20, 550, 100);
				required.setForeground(Color.decode("#0000ff"));
				required.setFont(new Font("Arial",Font.BOLD,25));
				required.setBounds(0,105,120,40);
				required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				...
				requinum.setFont(new Font("Arial",Font.BOLD,22));
				requinum.setBounds(70, 130, 350, 100);
				solution.setForeground(Color.decode("#0000ff"));
				solution.setFont(new Font("Arial",Font.BOLD,25));
				solution.setBounds(0,220,120,40);
				solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
			...
			if (button2.isSelected()) {
				...
				required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				required.setHorizontalAlignment(SwingConstants.CENTER);
				requinum = new JLabel("Parallel Total Capacitance (Ctotal)");
				requinum.setFont(new Font("Arial",Font.BOLD,22));
				requinum.setBounds(70, 130, 350, 100);
				solution.setForeground(Color.decode("#0000ff"));
				solution.setFont(new Font("Arial",Font.BOLD,25));
				...
				solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				solution.setHorizontalAlignment(SwingConstants.CENTER);
				solutop2.setText(String.format(cap1in+"   +   "+cap2in+"   +   "+cap3in));
				solutop2.setBounds(90, 270, 400, 75);
				solutop2.setFont(new Font("Arial", Font.BOLD, 30));
				solcor = new JLabel(" = ");
				solcor.setBounds(210, 365, 250, 25);
				solcor.setFont(new Font("Arial",Font.BOLD,30));
				answer2.setText(roundedValue + " F");
				answer2.setBounds(145, 437, 150, 30);
				answer2.setFont(new Font("Arial",Font.BOLD,30));
				answer2.setForeground(Color.decode("#009933"));
				answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				answer2.setHorizontalAlignment(SwingConstants.CENTER);
			...
			try {
		        ...
		        if (button1.isSelected()) {
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("M = "+hmassin+"  C = "+specin+"  Tf = "+tempin+"  Ti = "+temp2in);
					givenum.setFont(new Font("Arial",Font.BOLD,20));
					givenum.setBounds(30, 20, 550, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					required.setBounds(0,105,120,40);
					required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					required.setHorizontalAlignment(SwingConstants.CENTER);
					requinum = new JLabel("Amount of Heat (Q = ?)");
					requinum.setFont(new Font("Arial",Font.BOLD,22));
					requinum.setBounds(100, 130, 350, 100);
					solution.setForeground(Color.decode("#0000ff"));
					solution.setFont(new Font("Arial",Font.BOLD,25));
					solution.setBounds(0,220,120,40);
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					solution.setHorizontalAlignment(SwingConstants.CENTER);
					solutop2.setText(String.format("("+hmassin+")("+specin+")("+tempin+" - "+temp2in+")"));
					solutop2.setBounds(70, 270, 400, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 25));
					solcor = new JLabel(" = ");
					solcor.setBounds(210, 335, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,30));
					solut1.setText(String.format("("+hmassin+")("+specin+")("+roundedValue+")"));
					solut1.setBounds(119, 370, 250, 25);
					solut1.setFont(new Font("Arial",Font.BOLD,25));
					solcor2 = new JLabel(" = ");
					solcor2.setBounds(210, 405, 250, 25);
					solcor2.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setText(nroundedValue + " J");
					answer2.setBounds(145, 437, 150, 30);
					answer2.setFont(new Font("Arial",Font.BOLD,30));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
		        ...
		        if (button2.isSelected()) {
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("Q = "+reqin+"  C = "+specin+"  Tf = "+tempin+"  Ti = "+temp2in);
					givenum.setFont(new Font("Arial",Font.BOLD,20));
					givenum.setBounds(30, 20, 550, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					solution.setHorizontalAlignment(SwingConstants.CENTER);
					solut.setText(String.format(reqin+" "));
					solut.setBounds(185, 250, 250, 25);
					solut.setFont(new Font("Arial",Font.BOLD,20));
					solutop = new JLabel("___________________");
					solutop.setBounds(123, 257, 250, 25);
					solutop.setFont(new Font("Arial",Font.BOLD,18));
					solutop2.setText(String.format(specin+"("+tempin+" - "+temp2in+")"));
					solutop2.setBounds(135, 260, 250, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 20));
					solcor = new JLabel(" = ");
					solcor.setBounds(205, 317, 250, 25);
					solcor.setFont(new Font("Arial",Font.BOLD,25));
					solut1.setText(String.format(reqin+" "));
					solut1.setBounds(185, 350, 250, 25);
					solut1.setFont(new Font("Arial",Font.BOLD,20));
					solutop1 = new JLabel("___________________");
					solutop1.setBounds(123, 360, 250, 25);
					solutop1.setFont(new Font("Arial",Font.BOLD,18));
					solutop3.setText(String.format(specin+"("+roundedValue+")"));
					solutop3.setBounds(175, 370, 250, 75);
					solutop3.setFont(new Font("Arial", Font.BOLD, 20));
					solcor2 = new JLabel(" = ");
					solcor2.setBounds(205, 430, 250, 25);
					solcor2.setFont(new Font("Arial",Font.BOLD,25));
					answer2.setText(n2roundedValue + " grams");
					answer2.setBounds(145, 457, 150, 25);
					answer2.setFont(new Font("Arial",Font.BOLD,20));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					answer2.setHorizontalAlignment(SwingConstants.CENTER);
		        ...
		        if (button3.isSelected()) {
					...
					given.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					given.setHorizontalAlignment(SwingConstants.CENTER);
					givenum.setText("Q = "+reqin+"  M = "+hmassin+"  Tf = "+tempin+"  Ti = "+temp2in);
					givenum.setFont(new Font("Arial",Font.BOLD,20));
					givenum.setBounds(30, 20, 550, 100);
					required.setForeground(Color.decode("#0000ff"));
					required.setFont(new Font("Arial",Font.BOLD,25));
					...
					required.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					required.setHorizontalAlignment(SwingConstants.CENTER);
					requinum = new JLabel("Specific Heat (C = ?)");
					requinum.setFont(new Font("Arial",Font.BOLD,25));
					requinum.setBounds(125, 130, 350, 100);
					solution.setForeground(Color.decode("#0000ff"));
					solution.setFont(new Font("Arial",Font.BOLD,25));
					solution.setBounds(0,220,120,40);
					solution.setBorder(BorderFactory.createLineBorder(Color.BLACK));
					...
					solutop.setBounds(123, 257, 250, 25);
					solutop.setFont(new Font("Arial",Font.BOLD,18));
					solutop2.setText(String.format(hmassin+"("+tempin+" - "+temp2in+")"));
					solutop2.setBounds(135, 260, 250, 75);
					solutop2.setFont(new Font("Arial", Font.BOLD, 20));
					solcor = new JLabel(" = ");
					solcor.setBounds(205, 317, 250, 25);
					...
					solutop1.setBounds(123, 360, 250, 25);
					solutop1.setFont(new Font("Arial",Font.BOLD,18));
					solutop3.setText(String.format(hmassin+"("+roundedValue+")"));
					solutop3.setBounds(175, 370, 250, 75);
					solutop3.setFont(new Font("Arial", Font.BOLD, 20));
					solcor2 = new JLabel(" = ");
					solcor2.setBounds(205, 430, 250, 25);
					solcor2.setFont(new Font("Arial",Font.BOLD,25));
					answer2.setText(n2roundedValue + " J/g C");
					answer2.setBounds(145, 457, 150, 25);
					answer2.setFont(new Font("Arial",Font.BOLD,20));
					answer2.setForeground(Color.decode("#009933"));
					answer2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
